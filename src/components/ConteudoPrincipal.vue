...
<template>
    <main class="conteudo-principal">
        ...
        <KeepAlive include="SelecionarIngredientes">
            <SelecionarIngredientes v-if="conteudo === 'Selecionar Ingredientes'"
                @adicionarIngrediente="adicionarIngredientes"
                @removerIngrediente="removerIngrediente"
                @buscarReceitas="navegarPagina('Mostrar Receitas')"
            />

            <MostrarReceitas 
                v-else-if="conteudo === 'Mostrar Receitas'" 
                :ingredientes="ingredientes"
                @editarLista="navegarPagina('Selecionar Ingredientes')"
            />
        </KeepAlive>
    </main>
</template>
